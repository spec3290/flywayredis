...
import com.example.flywayredis.security.StompJwtChannelInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public WebSocketConfig(
            ...
            @Value("${app.websocket.allowed-origin-pattern:http://localhost:*}") String allowedOriginPattern
    ) {
